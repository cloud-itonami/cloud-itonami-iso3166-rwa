(ns marketentry.store
  "SSoT for the RWA market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems RW" :portal "Umucyo/RPPA"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-rw-entity? true :has-rw-entity? true
             :requires-rdb? true :rdb-verified? true
             :drafted? false :submitted? false
             :jurisdiction "RWA" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "Umucyo/RPPA"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-rw-entity? true :has-rw-entity? true
             :requires-rdb? true :rdb-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "Umucyo/RPPA"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "RWA" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "Umucyo/RPPA"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-rw-entity? true :has-rw-entity? false
             :requires-rdb? true :rdb-verified? true
             :drafted? false :submitted? false
             :jurisdiction "RWA" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "Umucyo/RPPA"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-rw-entity? true :has-rw-entity? true
             :requires-rdb? true :rdb-verified? false
             :drafted? false :submitted? false
             :jurisdiction "RWA" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "Umucyo/RPPA"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-rw-entity? has-rw-entity?
                               requires-rdb? rdb-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-rw-entity?)  (assoc :engagement/requires-rw-entity? requires-rw-entity?)
    (some? has-rw-entity?)       (assoc :engagement/has-rw-entity? has-rw-entity?)
    (some? requires-rdb?)    (assoc :engagement/requires-rdb? requires-rdb?)
    (some? rdb-verified?)    (assoc :engagement/rdb-verified? rdb-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-rw-entity? :engagement/has-rw-entity?
   :engagement/requires-rdb? :engagement/rdb-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-rw-entity? (boolean (:engagement/requires-rw-entity? m))
     :has-rw-entity? (boolean (:engagement/has-rw-entity? m))
     :requires-rdb? (boolean (:engagement/requires-rdb? m))
     :rdb-verified? (boolean (:engagement/rdb-verified? m))
