...
Open ISO 3166 Blueprint for **RWA**: Rwanda.
...
tax registration, and local-content rules in Rwanda, so the operator
...
- **Not the government of Rwanda.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Rwandan-licensed counsel
...
(ISO 3166 `RWA`). Required capabilities:
